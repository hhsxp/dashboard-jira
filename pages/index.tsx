...
export default function DashboardUpload() {
  ...
  const dadosFiltrados = filtroProjeto === "Todos" ? data : data.filter((item) => item["Projeto"] === filtroProjeto);
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl font-bold">Dashboard com Upload e Filtros</h1>
